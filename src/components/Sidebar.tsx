  ...
  return (
    <aside class="flex h-full w-64 shrink-0 flex-col border-r border-neutral-200 bg-neutral-50 dark:border-neutral-800 dark:bg-neutral-900">
      ...
      <div class="border-t border-neutral-200 p-3 dark:border-neutral-800">
        <Show when={store.capabilities.filesApi !== "unsupported"}>
          <button
        ...
        <Show when={store.capabilities.filesApi === "unsupported"}>
          <div class="mb-2 rounded border border-dashed border-neutral-300 px-3 py-1.5 text-xs text-neutral-500 dark:border-neutral-700 dark:text-neutral-400">
            Files extension unavailable
          </div>
        </Show>
        <button
